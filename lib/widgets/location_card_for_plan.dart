...
class LocationCardforPlan extends StatefulWidget {
  ...
  @override
  State<LocationCardforPlan> createState() => _LocationCardforPlanState();
}

class _LocationCardforPlanState extends State<LocationCardforPlan> {
  @override
